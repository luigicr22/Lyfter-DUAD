...
def exist_student(full_name, section, students):
    for pupil in students:
        if pupil.full_name == full_name:
            if pupil.section == section:
                print("El estudiante existe en esa sección.")
                return True
            else:
                add_student = input(f"El estudiante existe en la sección {pupil.section}. Presione \"S\" si desea contnuar de todos modos: ")
                if add_student == "S":
                    return False
                else:
                    return True
...
def exist_remove(full_name, section, students):
    for pupil in students:
        if pupil.full_name == full_name:
            if pupil.section == section:
                print("El estudiante existe en esa sección.")
